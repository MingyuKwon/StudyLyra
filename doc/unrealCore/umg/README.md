...
Slate 위에 올린 UObject 기반 UI 시스템. 게임 코드에서 직접 다루는 UI의 실체.

| 파일 | 내용 |
|------|------|
| [01_overview.md](01_overview.md) | UMG 개요, Slate와의 역할 분담 |
| [02_class_hierarchy.md](02_class_hierarchy.md) | UWidget 클래스 계층 — UWidget · UUserWidget · UPanelWidget · UContentWidget |
