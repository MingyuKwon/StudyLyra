...
`ui_pipeline.md`를 이해하기 위한 Slate 기초 개념 문서 모음.

| 파일 | 내용 |
|------|------|
| [01_overview.md](01_overview.md) | Slate가 무엇인가, UMG와의 관계, 왜 두 레이어인가 |
| [02_swidget.md](02_swidget.md) | SWidget 클래스 계층 — SLeafWidget · SCompoundWidget · SPanel |
